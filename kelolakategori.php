...
require_once 'core/init.php';
  ...
  if ( Input::get('hapus') ){
    $kelola->hapus('kategori', Input::get('hapus'));
  }
  ...
  if ( Input::get('submit') ) {
    ...
    if( $validation->passed() ) {
      ...
      $kelola->inKategori( array(
        'nama'   => Input::get('nmbarang'),
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form method="POST" action="kelolakategori.php">
                  <?php if( !empty($errors) ) {?>
            ...
            <div class="col">
              <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Tabel Ketegori</h6>
              </div>
              <div class="card-body">
